...
var _UsersListPage = __webpack_require__(119);
...
routes.set('home', (0, _assign2.default)({}, _HomePage2.default, { path: '/', exact: true }));
routes.set('users list', (0, _assign2.default)({}, _UsersListPage2.default, { path: '/users' }));
